        ...
        {!showPaymentButton ? (
          <form onSubmit={handleSubmit} className="inquiry-form">
            ...
            <div className="course-info-summary">
              ...
              <p><strong>Price:</strong> ₹{course.price} + GST <span style={{ fontSize: '0.85em', color: '#95a5a6' }}>(*18% taxes applicable)</span></p>
          ...
          <div className="payment-section">
            <div className="payment-info">
              ...
              <div className="course-info-summary">
                ...
                <p><strong>Course:</strong> {course.title}</p>
                <p><strong>Price:</strong> ₹{course.price} <span style={{ fontSize: '0.85em', color: '#95a5a6' }}>(*18% taxes applicable)</span></p>
              </div>
            </div>
